...
#lines(plot_data[,"pred_temp"]~plot_data[,"DOY"], col = "red")
#lines(merge_temp[,"air_tmax"]~merge_temp[,"DOY"], col = "orange")
#lines(merge_temp[,"ma30"]~merge_temp[,"DOY"], col = "orange")

library(ggplot2)
ggplot()+
  geom_line(data=plot_data,
            aes(x=DOY, y=pred_temp), col="red", lwd=0.8)+
  geom_line(data=wd,
            aes(x=DOY, y=air_tmax), col="darkblue", lwd=0.8)+
  geom_line(data=wd,
            aes(x=DOY, y=ma30), col="lightblue", lwd=0.8)+
