...
Let us now fix our time interval to be `r delta_t`` degree days.  There are several references we can use here to get estimates of some of our parameters. The results for $K$ are nicely summarised in @dodge2019.
